	...
	<div class="c-sb-section__body" style="padding-top: 8px;">
		<?php foreach ($licenses as $license_id => $license): ?>
			<ul class="c-sb-list c-sb-list--compact">
				...
				<li class="c-sb-list-item" style="font-size: 85%!important;">
			...
			<?php foreach ($license['children'] as $child_license_id => $child_license): ?>
				<ul class="c-sb-list c-sb-list--compact">
					...
					<li class="c-sb-list-item" style="font-size: 80%!important;">
						<?= $child_license['key'] ?>
						<a href="<?= $child_license['url']?>" target="_blank"><span class="icon-gear" style="top: 1px; margin-left: 4px;"></span></a>
					</li>
				</ul>
				<?php if ( $child_license['show_activations'] ): ?>
					<div class="c-sb-section c-sb-section--toggle nested" style="padding-bottom: 14px;">
						<div class="c-sb-section__title js-sb-toggle" style="font-size: 12px; border: none;">
			...
			<?php if ( $license['is_expired'] ): ?>
				<div class="c-sb-section" style="padding-bottom: 14px;">
